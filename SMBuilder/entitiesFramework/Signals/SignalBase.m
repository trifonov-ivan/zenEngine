...
#define GET_TARGET_ACTION_KEY(object, selector, block) [NSString stringWithFormat:@"%@%u%u", NSStringFromSelector(selector), [(NSObject *)object hash], [(NSObject *)block hash]]
